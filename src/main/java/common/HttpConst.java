...
public interface HttpConst {
    ...
    interface RequestHeaderKey{
        String Cookie = "Cookie".toLowerCase();
        String Origin = "Origin".toLowerCase();
        String Sec_WebSocket_Key = "Sec-WebSocket-Key".toLowerCase();
        String Cache_Control = "Cache-Control".toLowerCase();
        String Connection = "Connection".toLowerCase();
        String User_Agent = "User-Agent".toLowerCase();
        String Sec_WebSocket_Version = "".toLowerCase();
        String Host = "Host".toLowerCase();
        String Pragma = "Pragma".toLowerCase();
        String Accept_Encoding = "Accept-Encoding".toLowerCase();
        String Accept_Language="Accept-Language".toLowerCase();
        String Upgrade = "Upgrade".toLowerCase();
        String Sec_WebSocket_Extensions = "Sec-WebSocket-Extensions".toLowerCase();
        String Content_Length = "Content-Length".toLowerCase();
        String Content_Type = "Content-Type".toLowerCase();
        String If_Modified_Since = "If-Modified-Since".toLowerCase();
        String X_Requested_With = "X-Requested-With".toLowerCase();
    }

    interface RequestHeaderValue{
        interface Connection{
            String keep_alive = "keep_alive".toLowerCase();
            String Upgrade = "Upgrade".toLowerCase();
            String close = "close";
        }
